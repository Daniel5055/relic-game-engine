...
void relic::pong::PongGameScene::doInitialisation()
{
    ...
    {
        loadAssets({
            {"Fancy Font", {R"(.\Assets\Fonts\Astloch-bold.ttf)", 60}},
            });
    ...
    const framework::Shape paddle_1_pad = { 69, 190, 1, 100 };
    paddle_1.addComponent(new PongPaddlePhysicsComponent(paddle_1_pad, 'w', 's'));
    ...
    GameObject& paddle_2 = createObject("Paddle 1");
    const framework::Shape paddle_2_bounds = { 570, 190, 20, 100 };
    const framework::Shape paddle_2_pad = { 570, 190, 1, 100 };
    paddle_2.addComponent(new PongPaddlePhysicsComponent(paddle_2_pad, 'k', 'j'));
