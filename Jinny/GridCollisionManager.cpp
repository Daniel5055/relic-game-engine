...
double Jinny::GridCollisionManager::calculateStaticCollisionForces(double axis_velocity, double axis_force, double mass, double coeff_restitution, double time_left)
{
