...
jinny::AssetLoaderGraphicsComponent::AssetLoaderGraphicsComponent(
...
void jinny::AssetLoaderGraphicsComponent::loadFont(const std::string& font_name, const std::string& font_path, unsigned int font_size)
{
	m_asset_paths[font_name] = { font_path, font_size };
}

void jinny::AssetLoaderGraphicsComponent::loadTexture(const std::string& texture_name, const std::string& texture_path)
{
